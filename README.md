...
This repository contains code used in **Pfennig and Lachance, Limited selection on Neanderthal DNA in 30,780 recently admixed genomes with African-like ancestry, *Molecular Biology & Evolution*, 2026, [https://doi.org/10.1093/molbev/msag136](https://doi.org/10.1093/molbev/msag136)**. For a detailed description of methods, please refer to the publications. All analyses were implemented in a Snakemake workflow<sup>1</sup> (note that the workflows contained in `snakefiles` do not work independently but only in conjunction). 
